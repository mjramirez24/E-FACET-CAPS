<template>
  ...
  <button
    ...
    class="lg:hidden fixed top-4 left-4 z-50 bg-gradient-to-r from-blue-700 to-blue-600 text-white p-2.5 rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
  ...
  >
    <div class="flex-1 overflow-y-auto">
      ...
      <div class="flex items-center gap-2 p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
        <div class="logo-icon-wrapper-blue">
          <img
            src="/facet-logo.png"
            alt="FACET Logo"
      ...
      <nav class="mt-4 space-y-1">
        <router-link
          ...
          @click="closeMobileMenu"
        >
          <span class="nav-icon-wrapper-blue">
    ...
    <div class="shrink-0 bg-white">
      ...
      <div class="bg-gradient-to-r from-blue-800 to-blue-700 text-white p-4 flex items-center rounded-br-2xl">
        <div class="flex items-center gap-3 w-full">
          ...
          <div class="flex-shrink-0 w-2.5 h-2.5 bg-blue-300 rounded-full shadow-lg shadow-blue-500/50 animate-pulse"></div>
        </div>
      </div>
    </div>
  </aside>
        ...
        <div v-if="showLogoutModal" class="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div class="p-5">
            <p class="text-sm text-gray-700 leading-relaxed">
              Are you sure you want to sign out from your trainer account? Any unsaved changes will be lost.
            </p>
...
/* Logo icon wrapper - Blue theme */
.logo-icon-wrapper-blue {
  width: 40px;
  height: 40px;
...
.logo-icon-wrapper-blue:hover {
  transform: rotate(-5deg) scale(1.05);
  box-shadow: 0 4px 16px rgba(59, 130, 246, 0.25);
}

/* Navigation icons - Blue theme */
.nav-icon-wrapper-blue {
  width: 32px;
  height: 32px;
  border-radius: 8px;
  display: flex;
...
.router-link-exact-active .nav-icon-wrapper-blue {
