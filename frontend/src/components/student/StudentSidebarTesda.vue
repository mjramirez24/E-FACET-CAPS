  ...
  >
    <div class="flex-1 overflow-y-auto">
      ...
      <div class="flex items-center gap-2 p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
        ...
        <div>
          <h1 class="font-bold text-blue-900 text-base sm:text-lg">
            E-FACET TESDA
          </h1>
        ...
        <div v-if="showLogoutModal" class="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
          <div class="p-5 border-b border-gray-100">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500">TESDA student session</p>
              </div>
            </div>
          </div>
          ...
          <div class="p-5">
            <p class="text-sm text-gray-700 leading-relaxed">
              Are you sure you want to sign out from your TESDA student account? Any unsaved progress will be lost.
            </p>
