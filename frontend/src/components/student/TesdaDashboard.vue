  ...
  <StudentLayoutTesda active-page="dashboard">
    <template #header-left>
      <div class="flex items-center gap-3 w-full">
        <input
          ...
          class="w-full md:w-1/3 p-2 rounded-md text-gray-800 focus:outline-none"
        />
        <button
    ...
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <button
          @click="go('tesda-attendance')"
          class="bg-white border border-gray-200 rounded-xl p-5 text-left shadow-sm hover:shadow transition"
        >
          <div class="text-sm text-gray-500">Quick Link</div>
          <div class="mt-1 font-semibold text-blue-800">✅ Attendance</div>
          <div class="text-xs text-gray-500 mt-1">View your attendance records</div>
        </button>
      </div>

      <!-- Attendance Section -->
      <div
        class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-8 cursor-pointer hover:shadow-md transition"
        @click="go('tesda-attendance')"
      >
        <div class="flex items-center justify-between mb-4">
          <h3 class="text-md font-semibold text-blue-800">🗓️ Attendance</h3>
          <button
            @click.stop="go('tesda-attendance')"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
          <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
            ...
            <div class="text-lg font-bold text-green-700">{{ attendance.present }}</div>
          </div>

          <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
            <div class="text-xs text-gray-500">Late</div>
            <div class="text-lg font-bold text-yellow-600">{{ attendance.late }}</div>
          </div>

          <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
            <div class="text-xs text-gray-500">Excused</div>
            <div class="text-lg font-bold text-blue-700">{{ attendance.excused }}</div>
          </div>

          <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
            <div class="text-xs text-gray-500">Unmarked</div>
            <div class="text-lg font-bold text-gray-700">{{ attendance.unmarked }}</div>
          </div>
        </div>
      </div>
